...
interface IProps {
	handleChangeSelect: (option: Option | null) => void;
}

const ReservationTimeArrival: FC<IProps> = ({ handleChangeSelect }) => {
	return (
		<div>
			<div className="reservationD__time__top">
				...
				<p>
					Tu habitación va a estar lista para el check-in entre las 11:00hs. y las
					20:00hs.
				</p>
			</div>
